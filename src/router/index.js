...
export default new Router({
	routes: [
		...
		{
			path:'/code-study/007-rate',
			name: 'code-study-007-rate',
			component: resolve => require(['@/views/code-study/007-rate.vue'], resolve),
		},
		{
		...
		},
		{
			path: '/test9/table3',
			name: 'test9-table3',
			component: resolve => require(['@/views/test9/table3.vue'], resolve)
		},
		{
			path: '/test9/table4',
			name: 'test9-table4',
		...
		{
			path: '/test9/queryPage',
			name: 'test9-queryPage',
			component: resolve => require(['@/views/test9/queryPage.vue'], resolve)
		},
		{
			path: '/test9/sass',
			name: 'test9-sass',
		...
		},
		{
			path: '/test9/table5',
			name: 'test9-table5',
			component: resolve => require(['@/views/test9/table5.vue'], resolve)
		},
		{
			path: '/test9/loading2',
			name: 'test9-loading2',
